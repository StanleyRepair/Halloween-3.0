...
function mount(host){
  ...
  function reset(){score=0;wave=1;nextWave=1;rows=[];spawnClock=0;bullets=[];parts=[];damage=1;delay=.24;multi=1;fire=0;destroyed=0;bonusProgress=0;bonusTarget=3+Math.floor(Math.random()*2);x=target=270;addRow();hud();draw()}
