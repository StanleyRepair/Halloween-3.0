...
const versionFooter=document.createElement('footer');versionFooter.className='admin-version-footer';versionFooter.innerHTML='HALLOWEEN 3.0 <span class="version-dot"></span> wersja <strong id="adminAppVersion">sprawdzanie…</strong>';document.querySelector('.admin-shell')?.appendChild(versionFooter);
