...
function installContestCompressionV3(){
  window.compressImage=async function(file){
    ...
    try{
      ...
      let ctx=null;
      try{ctx=canvas.getContext('2d',{alpha:false,colorSpace:'display-p3'})}catch{}
  ...
  window.H3ContestCompression={version:3,maxSide:2048,jpegQuality:0.90,colorSpace:'display-p3-with-fallback'};
}
